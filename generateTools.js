...
// --- Create tool page with full styled template ---
...
.download-btn{display:inline-block;margin-top:15px;padding:8px 16px;background:#1e90ff;color:#fff;text-decoration:none;border-radius:6px;font-weight:600;transition:0.3s;}
...
<h1>${tool.name}</h1>
<div class="meta">
<p><strong>Platform:</strong> ${tool.console}</p>
